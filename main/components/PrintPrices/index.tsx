...
import { PrintColor } from "@/shared/types";
...
export default function PrintPrices() {
  return (
    <Tabs
      tabs={[
        {
          id: PrintColor.blackAndWhite,
          label: PrintColor.blackAndWhite,
          content: (
        ...
        {
          id: PrintColor.normalColor,
          label: PrintColor.normalColor,
          content: (
            <table className={styles.PrintPricesTable}>
              <thead>
                <tr>
        ...
        {
          id: PrintColor.fullColor,
          label: PrintColor.fullColor,
          content: (
            <table className={styles.PrintPricesTable}>
              <thead>
                <tr>
