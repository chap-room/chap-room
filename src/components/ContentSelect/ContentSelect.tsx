...
//   ]);
//   if (placeholder) listContentRef.current.push(placeholder);
//   listContentRef.current.concat(Object.values(options));

//   const [open, setOpen] = useState(false);
//   const [activeIndex, setActiveIndex] = useState<number | null>(null);
//   const [selectedIndex, setSelectedIndex] = useState(
//     value ? Math.max(0, listContentRef.current.indexOf(value)) : 0
//   );
...
//     if (placeholder) {
//       onChange(listContentRef.current[index]);
//     } else {
//       onChange(listContentRef.current[index]!);
//     }
//     setOpen(false);
...
//         })}
//       >
//         <span>{listContentRef.current[selectedIndex]}</span>
